...
Opening a pull request will trigger a[workflow](../.github/workflows/yjlee_mlops_on_bricks-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-c9c56981-f27d.cloud.databricks.com/explore/data/models/staging/yjlee_mlops_on_bricks/yjlee_mlops_on_bricks-model)
* [Prod model in UC](https://dbc-0060bab4-9db5.cloud.databricks.com/explore/data/models/prod/yjlee_mlops_on_bricks/yjlee_mlops_on_bricks-model)
. 
