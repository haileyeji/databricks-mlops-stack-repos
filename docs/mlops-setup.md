...
git add README.md docs .gitignore yjlee_mlops_on_bricks/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-c9c56981-f27d.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-0060bab4-9db5.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[yjlee_mlops_on_bricks/databricks.yml](../yjlee_mlops_on_bricks/databricks.yml) file.
...
Follow the instructions in [yjlee_mlops_on_bricks/resources/README.md](../yjlee_mlops_on_bricks/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../yjlee_mlops_on_bricks/resources/README.md)  to propose, test, and deploy
