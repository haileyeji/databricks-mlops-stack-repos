...
```
yjlee_mlops_on_bricks        <- Root directory. Both monorepo and polyrepo are supported.
│
├── yjlee_mlops_on_bricks       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
...
the [project README](./yjlee_mlops_on_bricks/README.md).
...
After that, follow the [ML pull request guide](docs/ml-pull-request.md)
 and [ML resource config guide](yjlee_mlops_on_bricks/resources/README.md)  to propose, test, and deploy changes to production ML code (e.g. update model parameters)
or pipeline resources (e.g. use a larger instance type for model training) via pull request.

| Role                          | Goal                                                                         | Docs                                                                                                                                                                |
|-------------------------------|------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Data Scientist                | Get started writing ML code for a brand new project                          | [project README](./yjlee_mlops_on_bricks/README.md) |
...
| Data Scientist                | Modify production model ML resources, e.g. model training or inference jobs  | [ML resource config guide](yjlee_mlops_on_bricks/resources/README.md)  |
...
need to run it again for project `yjlee_mlops_on_bricks`.
