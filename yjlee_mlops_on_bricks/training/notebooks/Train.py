...
# ``yjlee_mlops_on_bricks/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-yjlee_mlops_on_bricks-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.yjlee_mlops_on_bricks.yjlee_mlops_on_bricks-model", label="Full (Three-Level) Model Name"
)
